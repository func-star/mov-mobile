...
var TabsCtrl = function (_Events) {
	...
	function TabsCtrl() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TabsCtrl.__proto__ || Object.getPrototypeOf(TabsCtrl)).call.apply(_ref, [this].concat(args))), _this), _this.itemKeyInfo = {}, _temp), _possibleConstructorReturn(_this, _ret);
	}
	...
	_createClass(TabsCtrl, [{
		...
		value: function setTabItemKey(tabsKey, key) {
		...
		key: 'getTabsItemKey',
		value: function getTabsItemKey(tabsKey) {
			var key = this.itemKeyInfo['itemKeyList' + tabsKey];
			return key ? key : [];
		}
	}, {
		key: 'destroyItemList',
		value: function destroyItemList(tabsKey) {
